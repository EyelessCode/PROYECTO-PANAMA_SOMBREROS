...
//                 </div>
//             </form>
//             <div id="popup" class="popup-nueva-consulta" display="none">
//                 <!--*  popoupdinámico -->
//                 <div class="contenedor-popup">
//                     <h2>Agregue una nueva Categoría</h2>
//                     <div class="part categoria">
//                         <label for="txtCategoria">Categoría: </label>
//                         <!--*  diámico -->
//                         <input type="text" name="categoria" id="txtCategoria" maxlength="25" required placeholder="Categoría...">
//                     </div>

//                     <div class="part boton">
//                         <!--* din+amicooo ttulo dinámico  -->
//                         <button type="submit" id="btnAgregar">Agregar nuevo</button>
